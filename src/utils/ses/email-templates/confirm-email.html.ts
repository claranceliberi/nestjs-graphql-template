                    ...
                    <tr>
                      <td style="padding: 45px;">
                        <div style="font-size: 16px;">
                          <h1 style="font-weight: 700; font-size: 24px; margin-top: 0; text-align: left; color: #333333;">Confirm your email address</h1>
                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                  <tr>
                                    <td align="center" style="font-size: 16px;">
                                      <a href="{{actionurl}}" class="button" target="_blank" style="display: inline-block; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 8px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); background-color: #059669; border-color: #059669; border-style: solid; border-width: 16px 32px;">Confirm email address</a>
                                    </td>
                                  </tr>
                                </table>
                              </td>
