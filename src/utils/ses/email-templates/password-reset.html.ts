                    ...
                    <tr>
                      <td style="padding: 45px;">
                        <div style="font-size: 16px;">
                          ...
                          <p style="font-size: 16px; line-height: 24px; margin-top: 6px; margin-bottom: 20px; color: #51545e;">The password for your {{product}} account has been successfully reset. If you didn’t make this change or if you believe an unauthorized person has accessed your account, click on the button below.</p>
                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                  <tr>
                                    <td align="center" style="font-size: 16px;">
                                      <a href="{{actionurl}}" class="button" target="_blank" style="display: inline-block; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 8px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); background-color: #059669; border-color: #059669; border-style: solid; border-width: 16px 32px;">Reset now password</a>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                          ...
                          <p style="font-size: 16px; line-height: 24px; margin-top: 6px; margin-bottom: 20px; color: #51545e;">
                            ...
                            If you did not request a password reset, please ignore this email or <a href="{{supporturl}}" style="color: #3869d4;">contact support</a> if you have questions.
                          </p>
                          <p style="font-size: 16px; line-height: 24px; margin-top: 6px; margin-bottom: 20px; color: #51545e;">
                            Thanks,
                            <br>The {{product}} Team
